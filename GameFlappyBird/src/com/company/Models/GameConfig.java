...
public class GameConfig {
    ...
    public boolean isInScreen(Rectangle gameObject) {
        return gameObject.getX() > 0 && gameObject.getX() < this.screenWidth- gameObject.getWidth()
                && gameObject.getY() > 0 && gameObject.getY() < this.screenHeight - gameObject.getHeight();
    }
